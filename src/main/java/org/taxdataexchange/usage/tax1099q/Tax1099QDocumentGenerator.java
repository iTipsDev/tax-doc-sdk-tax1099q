...
import irs.fdxtax641.jsonserializers.Tax1099QSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Q;
import org.taxdataexchange.core.pdfbuilders.Tax1099QPdfBuilder;
...
public class Tax1099QDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Q obj = Map2Tax1099Q.generate( row );
        {
            String asJson = Tax1099QSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Q.csv";
        ...
        String outputFileName = "Tax1099Q.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099QDocumentGenerator generator = new Tax1099QDocumentGenerator( );
