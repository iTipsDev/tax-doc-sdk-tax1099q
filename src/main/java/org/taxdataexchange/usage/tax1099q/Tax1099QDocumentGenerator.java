package org.taxdataexchange.usage.tax1099q;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1099q.models.*;
import org.taxdataexchange.docs.tax1099q.utils.*;

public class Tax1099QDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099Q" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1099QPdfBuilder pdfBuilder = new Tax1099QPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1099Q.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099Q.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099Q.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099Q.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099Q.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1099QDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1099QDocumentGenerator Done" );
